...
def grid_search(model, tuned_parameters, X, Y):
    ...
    print("Task Completed! Completion time: " + str(datetime.now() - startTime) + "\n")
...
X, P, Y, Q = data.colorectal_cancer_data()
# Estimate parameters

rf_pg = [{'n_estimators': [100, 200, 300, 400, 500], 'random_state': [0]}]
